...
const introduction = {
    title: "ผมชื่อเก่งกิจ พร้อมสุทธิพงศ์ ชื่อเล่นชื่อเก่งครับ",
    paragraph: "",
...
const experience = {
    title: "กรุงเทพ ประเทศไทย - ธันวาคม 1997",
    records:[
        {
            date: "พฤษภาคม 2009",
            background: "1",
        ...
        },
        {
            ...
            subtitle: "ภาคเครื่องกล สาขาโรโบติกส์",
            content:["ปริญญาตรี",
            "รางวัล President Award จากคณะวิศวกรรมศาสตร์",
            "พรีเซนต์เปเปอร์งานวิจัยที่ SII2020 Conference",
            "GPA: 3.96/4.00"]
        },
        {
            date: "สิงหาคม 2018",
            ...
            subtitle: "อินเทิร์นชิป (1 เดือน)",
            content:["การควบคุมและระบบอัตโนมัติของหุ่นยนต์ไร้คนขับ"]
        },
        {
            date: "ตุลาคม 2019",
            background: "1",
            ...
            subtitle: "ภาคเครื่องกล สาขาโรโบติกส์",
            content:["ปริญญาโท",
            "งานวิจัยร่วมกับบริษัทหุ่นยนต์-จัดแสดงที่งานหุ่นยนต์IREX2019"]
        },
        {
            date: "สิงหาคม 2020",
            background: "2",
            ...
            subtitle: "อินเทิร์นชิป (2 สัปดาห์)",
            content:["พัฒนาแอพพลิเคชั่นมือถือด้วย Kotlin และ Android Architecture"]
        },
        {
            date: "กุมภาพันธ์ 2021",
            background: "2",
            icon: "work",
...
const showcase = {
    background: "เริ่มต้นจากการเรียนในสาขาหุ่นยนต์ ผมเริ่มมีความสนใจในด้านซอฟต์แวร์และรักการเขียนโปรแกรมมากขึ้นเรื่อยๆ เพื่อที่จะได้ทำงานในฐานะผู้พัฒนาซอฟต์แวร์ในอนาคต ผมเริ่มที่จะเรียนรู้ภาษาและเฟรมเวิร์คต่างๆและสร้างโปรเจ็คเล็กๆ ผมมีความสนใจและความสามารถหลากหลายด้านไม่ว่าจะเป็นแอพพลิเคชั่นเว้ปหรือโมไบล์ ฟรอนท์เอนด์หรือแบคเอนด์",
    frameworks: [
        {
            name: "Spring",
